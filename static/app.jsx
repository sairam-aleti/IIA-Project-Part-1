            ...
            {activeTab === 'ui' && (
                <div className="card">
                    ...
                    <div className="form-group" style={{marginBottom: '1rem'}}>
                        ...
                        <input className="form-control" type="text" value={form.reported_stolen_on} onChange={e => setForm({...form, reported_stolen_on: e.target.value})} />
                    </div>
                    <div className="form-group" style={{marginBottom: '1rem'}}>
                        <label>FIR Number</label>
                        <input className="form-control" type="text" value={form.fir_number} onChange={e => setForm({...form, fir_number: e.target.value})} />
                    </div>
                    <div className="form-group" style={{marginBottom: '1rem'}}>
